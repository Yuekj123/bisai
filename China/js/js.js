    ...
    series: [
      {
        name: "条",
        type: "bar",
        data: [234, 551, 1660, 3046, 4335, 5575,7017, 8249, 9899],
        yAxisIndex: 0,
        // 修改第一组柱子的圆角
        itemStyle: {
          barBorderRadius: 20,
...
//    option.series[1].data = obj.data[1];
	...
	function echarts_4() {
        ...
        xAxis: {
            ...
            data: ["红色主题志愿服务活动","文化文艺志愿服务","文化展览志愿服务","文化保护志愿服务","合作与资源整合","线上线下结合","研究创新类志愿服务","实践体验类志愿服务","创新活动形式"],
        ...
        series: [ {
            ...
            data: [10.2, 8.5, 7.2, 5.7, 4.5, 3.1, 1.7, 1.3, 0.7],
